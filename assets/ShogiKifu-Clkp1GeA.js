...
`)}
`},ln=["９","８","７","６","５","４","３","２","１"],ie=(e,s=O)=>{var r;let n=s;for(;(r=e[n])!=null&&r.children[0];)n=e[n].children[0];return n},cn=e=>{var n;const s=JSON.parse(e);if(!((n=s.nodes)!=null&&n[O]))throw new Error("JSON 中没有 root 节点。");return{nodes:s.nodes,currentId:s.currentId&&s.nodes[s.currentId]?s.currentId:ie(s.nodes)}},dn=(e,s)=>{if(!(e<1||e>9||s<1||s>9))return(s-1)*9+(9-e)},un=(e,s)=>{const n=ln.indexOf(e),r=ae.indexOf(s);if(!(n<0||r<0))return r*9+n},hn=(e,s)=>{const n=e.match(/^\s*(\d+)\s+(.+)$/);if(!n)return null;const r=Number(n[1]);if(!Number.isFinite(r))return null;const a=n[2].trim().replace(/\s+\(.+$/,""),h=(a.startsWith("△")?"gote":a.startsWith("▲")?"sente":void 0)??(r%2===1?"sente":"gote");let o=a.replace(/^[▲△]/,"").replace(/\u3000/g," ").trim(),p;if(o.startsWith("同")?(p=s,o=o.replace(/^同\s*/,"")):(p=un(o.slice(0,1),o.slice(1,2)),o=o.slice(2).trim()),p===void 0)return null;const v=Ue.find(([l])=>o.startsWith(l));if(!v)return null;const[b,g,f]=v,j=o.slice(b.length),C=j.match(/\(([1-9])([1-9])\)/),i=C?dn(Number(C[1]),Number(C[2])):void 0;return{moveNumber:r,owner:h,piece:g,promotedBefore:f,promotedAfter:f||!f&&j.includes("成")&&!j.includes("不成"),from:i,to:p,drop:j.includes("打"),notation:a}},mn=(e,s)=>{const n=e.findIndex(r=>!!r&&(r==null?void 0:r.owner)===s.owner&&r.kind===s.piece&&r.promoted===s.promotedBefore);return n>=0?n:void 0},pn=(e,s,n)=>{const r=A(e),a=X(s),c=n.drop?void 0:n.from??mn(e,n),h=c!==void 0&&r[c]?r[c]:K(n.piece,n.owner,n.promotedBefore,`import-${n.moveNumber}`),o=r[n.to];return c!==void 0&&(r[c]=null),n.drop&&n.piece!=="K"&&a[n.owner][n.piece]>0&&(a[n.owner][n.piece]-=1),o&&o.kind!=="K"&&(a[n.owner][o.kind]+=1),r[n.to]={...h,owner:n.owner,kind:n.piece,promoted:n.promotedAfter},{board:r,hands:a,record:{owner:n.owner,piece:n.piece,promotedBefore:n.promotedBefore,promotedAfter:n.promotedAfter,from:c,to:n.to,drop:n.drop,captured:o?{kind:o.kind,promoted:o.promoted,owner:o.owner}:void 0,notation:n.notation}}},fn=(e,s)=>!!e&&e.owner===s.owner&&e.piece===s.piece&&e.promotedBefore===s.promotedBefore&&e.promotedAfter===s.promotedAfter&&e.from===s.from&&e.to===s.to&&!!e.drop===s.drop,gn=e=>{const s=re(),n={[O]:s};let r=O,a=null,c=0;const h=Date.now(),o=new Set,p={0:O},v=(b,g,f)=>{const j=n[b];if(j){if(f||o.has(b)){j.children=[...j.children,g];return}j.children=[g,...j.children],o.add(b)}};return e.split(/\r?\n/).forEach(b=>{var $;const g=b.trim();if(!g)return;const f=g.match(/^変化：\s*(\d+)手/);if(f){a=Number(f[1]);return}if(g.startsWith("*")){const k=n[r]??n[O];k.comment=[k.comment,g.slice(1).trim()].filter(Boolean).join(`
`);return}if(g.startsWith("#")||g.includes("手数----"))return;const j=g.match(/^\s*(\d+)\s+/),C=j?Number(j[1]):NaN;if(!Number.isFinite(C))return;const i=p[C-1],l=i?n[i]:void 0;if(!l)return;const u=hn(g,($=l.move)==null?void 0:$.to);if(!u)return;const B=l.children.find(k=>{var T;return fn((T=n[k])==null?void 0:T.move,u)});if(B){r=B,p[u.moveNumber]=B,Object.keys(p).forEach(k=>{Number(k)>u.moveNumber&&delete p[Number(k)]}),a=null;return}const M=pn(l.board,l.hands,u);c+=1;const P=`import-${u.moveNumber}-${c}`,R=a===u.moveNumber;v(i,P,R),n[P]={id:P,parentId:i,children:[],move:M.record,board:M.board,hands:M.hands,comment:"",moveNumber:u.moveNumber,createdAt:h+c},r=P,p[u.moveNumber]=P,Object.keys(p).forEach(k=>{Number(k)>u.moveNumber&&delete p[Number(k)]}),a=null}),{nodes:n,currentId:ie(n)}},le=e=>e==="sente"?-1:1,ge=(e,s)=>{const{row:n}=_(s);return e==="sente"?n<=2:n>=6},xn=(e,s,n)=>!e.promoted&&H.includes(e.kind)&&(ge(e.owner,s)||ge(e.owner,n)),bn=(e,s)=>{if(e.promoted)return!1;const{row:n}=_(s);return e.kind==="P"||e.kind==="L"?e.owner==="sente"?n===0:n===8:e.kind==="N"?e.owner==="sente"?n<=1:n>=7:!1},Y=(e,s,n,r,a)=>{const c=_(s),h=_(n);let o=c.row+r,p=c.col+a;for(;o!==h.row||p!==h.col;){if(e[o*9+p])return!1;o+=r,p+=a}return!0},xe=(e,s,n)=>{const r=le(e);return s===r&&Math.abs(n)<=1||s===0&&Math.abs(n)===1||s===-r&&n===0},jn=(e,s,n)=>{const r=le(e);return s===r&&Math.abs(n)<=1||s===-r&&Math.abs(n)===1},we=(e,s,n,r)=>{const a=_(n),c=_(r),h=c.row-a.row,o=c.col-a.col,p=Math.abs(h),v=Math.abs(o),b=le(s.owner);if(h===0&&o===0)return!1;if(s.promoted&&["S","N","L","P"].includes(s.kind))return xe(s.owner,h,o);switch(s.kind){case"K":return Math.max(p,v)===1;case"G":return xe(s.owner,h,o);case"S":return jn(s.owner,h,o);case"N":return h===b*2&&v===1;case"L":return o===0&&h*b>0&&Y(e,n,r,b,0);case"P":return o===0&&h===b;case"R":return h===0&&o!==0?Y(e,n,r,0,Math.sign(o)):o===0&&h!==0?Y(e,n,r,Math.sign(h),0):s.promoted&&p===1&&v===1;case"B":return p===v?Y(e,n,r,Math.sign(h),Math.sign(o)):s.promoted&&(p===1&&o===0||h===0&&v===1);default:return!1}},Nn=(e,s,n)=>{const{col:r}=_(n);return e.some((a,c)=>c%9===r&&(a==null?void 0:a.owner)===s&&a.kind==="P"&&!a.promoted)},ke=(e,s)=>{const n=e.findIndex(r=>(r==null?void 0:r.owner)===s&&r.kind==="K");return n<0?!1:e.some((r,a)=>!!r&&(r==null?void 0:r.owner)!==s&&we(e,r,a,n))},Sn=(e,s,n,r)=>{const a=A(e),c=a[n];return c?(a[n]=null,a[r]=c,ke(a,s)):!1},vn=(e,s,n,r)=>{const a=A(e);return a[r]={id:"validation-drop",kind:n,owner:s,promoted:!1},ke(a,s)},wn=(e,s,n,r)=>{const a=e[n],c=e[r];return a?a.owner!==s?{legal:!1,reason:`现在轮到${E[s].label}。`}:(c==null?void 0:c.owner)===a.owner?{legal:!1,reason:"不能吃自己的棋子。"}:(c==null?void 0:c.kind)==="K"?{legal:!1,reason:"不能直接吃王。"}:we(e,a,n,r)?Sn(e,a.owner,n,r)?{legal:!1,reason:"这手会让己方王处于被攻击状态。"}:{legal:!0,canPromote:xn(a,n,r),mustPromote:bn(a,r)}:{legal:!1,reason:"该棋子的走法不能到达目标格。"}:{legal:!1,reason:"没有可移动的棋子。"}},kn=(e,s,n,r,a,c)=>{if(r!==n)return{legal:!1,reason:`现在轮到${E[n].label}。`};if(e[c])return{legal:!1,reason:"目标格已有棋子。"};if(s[r][a]<=0)return{legal:!1,reason:"没有这枚持驹。"};const{row:h}=_(c);return(a==="P"||a==="L")&&(r==="sente"?h===0:h===8)?{legal:!1,reason:"步兵和香车不能打在最后一段。"}:a==="N"&&(r==="sente"?h<=1:h>=7)?{legal:!1,reason:"桂马不能打在无法前进的段。"}:a==="P"&&Nn(e,r,c)?{legal:!1,reason:"同一筋不能有两枚未升变的步。"}:vn(e,r,a,c)?{legal:!1,reason:"这手不能解除己方王被攻击。"}:{legal:!0}},Cn=(e,s)=>!!e&&e.owner===s.owner&&e.piece===s.piece&&e.promotedBefore===s.promotedBefore&&e.promotedAfter===s.promotedAfter&&e.from===s.from&&e.to===s.to&&!!e.drop==!!s.drop,Pn=({board:e,currentId:s,hands:n,mode:r,nextPlayer:a,nodes:c,pendingPromotion:h,selection:o,serialRef:p,setupOwner:v,setupPromoted:b,pushNotice:g,setBranchArmed:f,setCurrentId:j,setMode:C,setNodes:i,setPendingPromotion:l,setSelection:u,setSetupOwner:B,setSetupPromoted:M})=>{const P=()=>{u(null),l(null)},R=(d,m,N=!1)=>(p.current+=1,K(d,m,N,`runtime-${p.current}`)),$=(d,m)=>{i(N=>({...N,[s]:{...N[s],board:d,hands:m}}))},k=(d,m,N)=>{const S=c[s];if(!S)return;const y=S.children.find(w=>{var U;return Cn((U=c[w])==null?void 0:U.move,d)});if(y){j(y),P(),f(!1);return}p.current+=1;const I=`node-${Date.now().toString(36)}-${p.current}`,x={...d,notation:on(d)};i(w=>({...w,[s]:{...w[s],children:[...w[s].children,I]},[I]:{id:I,parentId:s,children:[],move:x,board:m,hands:N,comment:"",moveNumber:S.moveNumber+1,createdAt:Date.now()}})),j(I),P(),f(!1)},T=(d,m,N=!1)=>{const S=e[d],y=e[m];if(!S)return;const I=A(e),x=X(n),w=S.promoted||N;I[d]=null,I[m]={...S,promoted:w},y&&y.kind!=="K"&&(x[S.owner][y.kind]+=1),k({owner:S.owner,piece:S.kind,promotedBefore:S.promoted,promotedAfter:w,from:d,to:m,captured:y?{kind:y.kind,promoted:y.promoted,owner:y.owner}:void 0},I,x)},J=(d,m,N)=>{const S=kn(e,n,a,d,m,N);if(!S.legal)return g(S.reason??"不能在这里打入。");const y=A(e),I=X(n);y[N]=R(m,d,!1),I[d][m]-=1,k({owner:d,piece:m,promotedBefore:!1,promotedAfter:!1,to:N,drop:!0},y,I)},V=(d,m)=>{if((o==null?void 0:o.source)==="palette"){const N=A(e);return N[d]=R(o.kind,o.owner,o.promoted),$(N,n),void l(null)}if((o==null?void 0:o.source)==="board"){if(o.index===d)return P();const N=A(e),S=N[o.index];return S?(N[o.index]=null,N[d]=S,$(N,n),u({source:"board",index:d}),void l(null)):P()}u(m?{source:"board",index:d}:null),l(null)},W=(d,m)=>{if((o==null?void 0:o.source)!=="board")return;if(o.index===d)return P();const N=e[o.index];if((m==null?void 0:m.owner)===(N==null?void 0:N.owner))return m.owner===a?(u({source:"board",index:d}),void l(null)):g(`现在轮到${E[a].label}。`);const S=wn(e,a,o.index,d);if(!S.legal)return g(S.reason??"这手不合法。");if(S.mustPromote)return T(o.index,d,!0);if(S.canPromote)return void l({from:o.index,to:d});T(o.index,d,!1)},Q=d=>{const m=e[d];if(r==="setup")return V(d,m);if((o==null?void 0:o.source)==="hand")return J(o.owner,o.kind,d);if((o==null?void 0:o.source)==="board")return W(d,m);if(m&&m.owner!==a)return g(`现在轮到${E[a].label}。`);u(m?{source:"board",index:d}:null),l(null)},z=d=>{C("setup"),u({source:"palette",kind:d,owner:v,promoted:b&&H.includes(d)})},F=(d,m)=>{if(!(r==="setup"||n[d][m]<=0)){if(d!==a)return g(`现在轮到${E[a].label}。`);u({source:"hand",owner:d,kind:m}),l(null)}},Z=(d,m,N)=>{const S=X(n);S[d][m]=Math.max(0,S[d][m]+N),$(e,S)},ee=()=>{if((o==null?void 0:o.source)!=="board")return;const d=A(e);d[o.index]=null,$(d,n),P()},ne=()=>{if((o==null?void 0:o.source)!=="board")return;const d=A(e),m=d[o.index];m&&(m.owner=m.owner==="sente"?"gote":"sente",$(d,n))},te=()=>{if((o==null?void 0:o.source)!=="board")return;const d=A(e),m=d[o.index];!m||!H.includes(m.kind)||(m.promoted=!m.promoted,$(d,n))};return{changeHandCount:Z,changeSetupOwner:d=>{B(d),(o==null?void 0:o.source)==="palette"&&u({...o,owner:d})},changeSetupPromoted:d=>{M(d),(o==null?void 0:o.source)==="palette"&&u({...o,promoted:d&&H.includes(o.kind)})},clearPosition:()=>{$(Ne(),Se()),P()},clearTransient:P,flipSelectedOwner:ne,handleBoardClick:Q,recordPendingPromotion:d=>h&&T(h.from,h.to,d),removeSelectedPiece:ee,selectHandPiece:F,selectPalettePiece:z,selectedBoardPiece:(o==null?void 0:o.source)==="board"?e[o.index]:null,setModeAndClear:d=>{C(d),P()},toggleSelectedPromotion:te}},En=()=>{const[e,s]=L.useState(()=>({[O]:re()})),[n,r]=L.useState(O),[a,c]=L.useState("record"),[h,o]=L.useState("sente"),[p,v]=L.useState(!1),[b,g]=L.useState(null),[f,j]=L.useState(null),[C,i]=L.useState(!1),[l,u]=L.useState("idle"),[B,M]=L.useState(""),[P,R]=L.useState(""),$=L.useRef(0),k=e[n]??e[O],T=k.board,J=k.hands,V=k.moveNumber%2===0?"sente":"gote",W=L.useMemo(()=>{var U;const x=[];let w=n;for(;w;)x.push(w),w=(U=e[w])==null?void 0:U.parentId;return x.reverse()},[n,e]),Q=L.useMemo(()=>W.map(x=>e[x]).filter(x=>!!(x!=null&&x.move)),[W,e]),z=x=>{M(x),window.setTimeout(()=>M(w=>w===x?"":w),1800)},F=Pn({board:T,currentId:n,hands:J,mode:a,nextPlayer:V,nodes:e,pendingPromotion:b,selection:f,serialRef:$,setupOwner:h,setupPromoted:p,pushNotice:z,setBranchArmed:i,setCurrentId:r,setMode:c,setNodes:s,setPendingPromotion:g,setSelection:j,setSetupOwner:o,setSetupPromoted:v}),Z=()=>{s({[O]:re()}),r(O),F.clearTransient(),i(!1),R(""),M("")},ee=()=>{if(n===O||!k.parentId)return;const x=k.parentId,w=[n,...ve(e,n)];s(U=>{const G={...U};return w.forEach(se=>delete G[se]),G[x]={...G[x],children:G[x].children.filter(se=>se!==n)},G}),r(x),F.clearTransient()},ne=()=>{k.parentId&&r(k.parentId),F.clearTransient(),i(!0)},te=x=>{s(w=>({...w,[n]:{...w[n],comment:x}}))},d=x=>{try{const w=x.extension==="json"?cn(x.content):gn(x.content);s(w.nodes),r(w.currentId),F.clearTransient(),i(!1),R(x.path),z(`已载入 ${x.title}`)}catch(w){z(w instanceof Error?w.message:"棋谱读取失败。")}},m=an(e),N=()=>pe(`luna-shogi-${fe()}.kif`,m,"text/plain;charset=utf-8"),S=()=>{const x={version:"luna-shogi-kifu-v1",exportedAt:new Date().toISOString(),currentId:n,nodes:e};pe(`luna-shogi-${fe()}.json`,JSON.stringify(x,null,2),"application/json;charset=utf-8")},y=()=>{navigator.clipboard.writeText(m).then(()=>{u("copied"),window.setTimeout(()=>u("idle"),1200)})},I=x=>{r(x),F.clearTransient(),i(!1)};return{activeStoredPath:P,board:T,branchArmed:C,copyKif:y,copyState:l,currentId:n,currentNode:k,deleteCurrentNode:ee,exportJson:S,exportKif:N,hands:J,kifPreview:m,loadStoredKifu:d,mode:a,moveLine:Q,nextPlayer:V,nodes:e,notice:B,pendingPromotion:b,pendingPromotionPiece:b?T[b.from]:null,resetToInitial:Z,selectNode:I,selection:f,setupOwner:h,setupPromoted:p,stepBack:()=>k.parentId&&I(k.parentId),stepForward:()=>k.children[0]&&I(k.children[0]),armSiblingBranch:ne,updateComment:te,...F}},Bn=e=>e instanceof HTMLElement?e.isContentEditable||e.closest("input, textarea, select, [contenteditable='true']")!==null:!1,On=({currentId:e,currentNode:s,mode:n,nodes:r,pendingPromotion:a,selectedBoardPiece:c,armSiblingBranch:h,cancelTransient:o,deleteCurrentNode:p,recordPendingPromotion:v,removeSelectedPiece:b,selectNode:g,setModeAndClear:f,stepBack:j,stepForward:C})=>{L.useEffect(()=>{const i=l=>{if(l.defaultPrevented||Bn(l.target)||l.altKey||l.ctrlKey||l.metaKey)return;const u=l.key.toLowerCase(),B=s.parentId?r[s.parentId]:void 0,M=(B==null?void 0:B.children)??[],P=M.indexOf(e),R=/^[1-9]$/.test(l.key)?Number(l.key)-1:-1;if(a){if(u==="enter"||u==="y"){l.preventDefault(),v(!0);return}if(u==="n"){l.preventDefault(),v(!1);return}u==="escape"&&(l.preventDefault(),o());return}if(R>=0&&s.children[R]){l.preventDefault(),g(s.children[R]);return}switch(u){case"arrowleft":s.parentId&&(l.preventDefault(),j());break;case"arrowright":s.children[0]&&(l.preventDefault(),C());break;case"arrowup":P>0&&(l.preventDefault(),g(M[P-1]));break;case"arrowdown":P>=0&&P<M.length-1&&(l.preventDefault(),g(M[P+1]));break;case"home":e!==O&&(l.preventDefault(),g(O));break;case"end":{const $=ie(r,e);$!==e&&(l.preventDefault(),g($));break}case"r":l.preventDefault(),f("record");break;case"s":l.preventDefault(),f("setup");break;case"b":l.preventDefault(),h();break;case"escape":l.preventDefault(),o();break;case"delete":n==="setup"&&c?(l.preventDefault(),b()):e!==O&&(l.preventDefault(),p());break}};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[h,o,e,s,p,n,r,a,v,b,c,g,f,j,C])},Ln=()=>{var s,n;const e=En();return On(e),t.jsxs("section",{className:"shogi-page relative min-h-screen overflow-hidden px-4 pb-20 pt-36 text-slate-100 md:px-8 md:pt-40",children:[t.jsx("div",{className:"shogi-scanline","aria-hidden":"true"}),t.jsx("div",{className:"shogi-grid-glow","aria-hidden":"true"}),t.jsxs("div",{className:"relative z-10 mx-auto flex w-full max-w-[1540px] flex-col gap-4",children:[t.jsx(Ve,{nextPlayer:e.nextPlayer,moveNumber:e.currentNode.moveNumber,nodeCount:Object.keys(e.nodes).length,branchArmed:e.branchArmed}),t.jsxs("div",{className:"shogi-workspace",children:[t.jsx(Je,{board:e.board,hands:e.hands,mode:e.mode,nextPlayer:e.nextPlayer,notice:e.notice,selection:e.selection,pendingPromotion:e.pendingPromotion,pendingPromotionPiece:e.pendingPromotionPiece,lastFrom:(s=e.currentNode.move)==null?void 0:s.from,lastTo:(n=e.currentNode.move)==null?void 0:n.to,onSetMode:e.setModeAndClear,onBoardClick:e.handleBoardClick,onHandSelect:e.selectHandPiece,onHandCountChange:e.changeHandCount,onPromotionChoice:e.recordPendingPromotion}),t.jsx(Ze,{nodes:e.nodes,currentId:e.currentId,currentNode:e.currentNode,branchArmed:e.branchArmed,onSelectNode:e.selectNode,onStepBack:e.stepBack,onStepForward:e.stepForward,onArmBranch:e.armSiblingBranch,onDeleteCurrent:e.deleteCurrentNode,onCommentChange:e.updateComment}),t.jsx(Qe,{moveLine:e.moveLine,currentId:e.currentId,setupOwner:e.setupOwner,setupPromoted:e.setupPromoted,selection:e.selection,selectedBoardPiece:e.selectedBoardPiece,storedFiles:rn,activeStoredPath:e.activeStoredPath,copyState:e.copyState,kifPreview:e.kifPreview,onSetupOwnerChange:e.changeSetupOwner,onSetupPromotedChange:e.changeSetupPromoted,onPaletteSelect:e.selectPalettePiece,onClearPosition:e.clearPosition,onReset:e.resetToInitial,onFlipSelectedOwner:e.flipSelectedOwner,onToggleSelectedPromotion:e.toggleSelectedPromotion,onRemoveSelectedPiece:e.removeSelectedPiece,onStoredLoad:e.loadStoredKifu,onExportKif:e.exportKif,onExportJson:e.exportJson,onCopyKif:e.copyKif,onSelectLineNode:e.selectNode})]})]})]})};export{Ln as default};
