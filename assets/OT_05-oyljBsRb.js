...
(iii) If $ \\boldsymbol{\\eta}_{0}=\\left(\\boldsymbol{\\lambda}_{0}, \\boldsymbol{\\mu}_{0}\\right) $ is a solution of the dual problem, then $ \\left(\\mathbf{x}^{*}, \\boldsymbol{\\eta}_{0}\\right) $ is a KKT pair for the primal problem.`;export{a as default};
