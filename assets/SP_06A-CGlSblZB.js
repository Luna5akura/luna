...
The denominator is $ \\lambda_{1}^{2}+\\lambda_{1} \\lambda_{2}+\\lambda_{2}^{2} $, and the numerator is $ K \\lambda_{1} \\lambda_{2}\\left(\\lambda_{1}+\\lambda_{2}\\right)+c_{1}\\left(\\lambda_{1}^{2}+\\lambda_{2}^{2}\\right)+ $ $ c_{2} \\lambda_{1} \\lambda_{2} $`;export{t as default};
