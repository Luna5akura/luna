...
export default function PromotionalPoster() {
  return (
    <div className="promo-container">
      ...
      <div className="bg-layer grid-pattern" />
      <div className="bg-layer radial-glow" />
      <div className="bg-layer floating-particles" />
      ...
      <div className="card-wrapper">
        ...
        <div className="card-content">
          ...
          <div className="limited-badge">
            <span>⚡ LIMITED 50 SETS ⚡</span>
          </div>
          
          {/* 艺术家标题 */}
          <div className="artist-tag">DJ MURASAME</div>
          ...
          <div className="sub-album">
            ＋ FREE CONNECTION 3 — DRUM'N BASS STYLE
          </div>
          ...
          <div className="details-box">
            <div className="disc-info">
              ...
              『BEYOND THE WAVE ＋ TECHNO-MATRIX』
              <span className="small-note">（2枚組・全28曲）</span>
            </div>
            <div className="disc-info">
              <span className="disc-icon">🎧</span>
              『FREE CONNECTION 3 / DJ MURASAME -DRUM'N BASS STYLE-』
            </div>
          </div>
          ...
          <div className="price-area">
            ...
            <div className="price-note">+ 运费另计</div>
          </div>
          
          {/* 特典专区 */}
          <div className="bonus-section">
            <div className="bonus-title">✨ 预约限定特典 ✨</div>
          ...
          <div className="info-grid">
            <div className="info-cell">
              <div className="info-label">🏪 独家销售</div>
              <div className="info-value">DIVERSE DIRECT</div>
              <div className="info-warning">仅限50套 · 售完即止</div>
            </div>
            <div className="info-cell">
              <div className="info-label">📅 预约时间</div>
              <div className="info-value">2025年4月3日 19:00 〜 4月19日</div>
              <div className="info-sub">预约开始后即可订购</div>
            </div>
            <div className="info-cell">
              <div className="info-label">📦 发售 / 发货</div>
              <div className="info-value">2025年4月26日</div>
              <div className="info-sub">发货自发售日起依次安排</div>
            </div>
          </div>
          
          {/* 购买警示 */}
          <div className="urgent-note">
            ⚠️ 由于限定50套，预计很快完售！请尽早预约。
          </div>
          
          {/* 购买引导 */}
          <div className="cta-button">
            <span>4月3日 19:00 预约开始 →</span>
          </div>
