...
| ものの | mono no | **Fact but unexpected**: 承认前项是事实，但后项与预期不符，正式，Particle | 買った**ものの**、一度も使っていない。<br>(虽然买了，但一次也没用过。) |
...
| にしては | ni shite wa | **Contrary to Expectation**: 基于前项的标准或预期，结果与说话者的想象不符（单纯陈述预期与现实的矛盾，常用于评价他人，带有意外或评价意味，不能用于自己） | 初心者**にしては**、とても上手だ。<br>(虽然是初学者，但非常熟练。) |
| にしても | ni shite mo | **Even if Acknowledging the Premise**: 即使说话者假设承认前项条件，后项仍与预期相反（带有对前提的认可，常表达不满或不解）；**与「にしては」的比较**：二者均表逆接/让步，但「にしては」为单纯描述“不符预期”，“にしても”则先认可前提再强调矛盾（前者重“意外”，后者重“不满”） | 安い**にしても**、高すぎる。<br>(即使便宜，也太贵了。)<br>※比较场景：帰りが遅くなると言っていた**にしては**早かった。（超出预期）／**にしても**遅すぎる。（认可前提仍不满） |
