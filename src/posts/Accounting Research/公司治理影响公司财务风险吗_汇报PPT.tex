...
\begin{frame}
  \bigidea{股权结构}
  \begin{itemize}
    \item \Large 非国有控股企业的风险显著高于国有控股企业
    \item \Large 股权越集中对企业风险无影响
    \item \Large 支持 H6，不支持 H7
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{lccc}
    ...
    N & + & 0.022 & -0.88 \\
    Size & + & 0.755 & 10.16*** \\
    Indi & ? & \multicolumn{2}{c}{控制} \\
    Yeari & ? & \multicolumn{2}{c}{控制} \\
    观测值 &  & \multicolumn{2}{c}{2379} \\
    F &  & \multicolumn{2}{c}{10.62***} \\
    Adj-R2 &  & \multicolumn{2}{c}{0.149} \\
    \bottomrule
  \end{tabular}
\end{frame}
...
\begin{frame}
  \bigidea{稳健性检验}
  \begin{itemize}
    \item \Large 企业财务风险变量换为年末资产负债率
    \item \Large Hausman 检验没有严重内生性
    \item \Large 剔除 ST 样本后结果没有发生明显变化
  \end{itemize}
\end{frame}
...
\begin{frame}
  \bigidea{论文结论}
  \begin{itemize}
    \item \Large 公司治理结构影响企业财务风险
    \item \Large 股权集中度、非国有控股：正相关  
    \item \Large 独立董事比例、高管持股、二职分离：负相关
    \item \Large 董事会规模、高管薪酬：不显著相关
  \end{itemize}
\end{frame}
...
\begin{frame}
  \bigidea{政策含义}
  \begin{itemize}
    \item \Large 改善公司治理结构能显著降低企业财务风险
    \item \Large 良好的公司治理能选出优秀的管理者，约束企业的高风险行为
    \item \Large 建立治理结构时应坚持“实质重于形式”
    \item \Large 要有选择地建立有效机制，而不是一味模仿西方
  \end{itemize}
\end{frame}
